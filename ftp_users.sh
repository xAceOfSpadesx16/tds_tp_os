...
echo "Comando de creacion de usuario: sudo useradd -d /srv/ftp/<username> -m -U -s /usr/sbin/nologin -k /etc/skel <username>"
...
sudo useradd -d /srv/ftp/$USUARIO_1 -m -U -s /usr/sbin/nologin -k /etc/skel $USUARIO_1
...
sudo useradd -d /srv/ftp/$USUARIO_2 -m -U -s /usr/sbin/nologin -k /etc/skel $USUARIO_2
